            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.segmento}
                    onChange={handleChange}
                    placeholder="Ex: fitness, alimentação..."
                    disabled={loading}
                    className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-600"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  value={form.contexto}
                  onChange={handleChange}
                  placeholder="Ex: cliente já tem imóvel disponível, prefere mercados menores..."
                  disabled={loading}
                  rows={3}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900 border border-red-900 rounded-2xl p-6">
              ...
              <h3 className="text-white font-bold text-xl mb-2">
                {resultado.veredito?.titulo}
              </h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                {resultado.veredito?.descricao}
              </p>
            </div>
